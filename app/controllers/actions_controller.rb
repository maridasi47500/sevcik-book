class ActionsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @action.update(action_params)
        format.html { redirect_to @action, notice: "Action was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to actions_path, notice: "Action was successfully destroyed.", status: :see_other }
